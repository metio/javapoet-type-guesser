...
All currently required features are implemented. This project is in maintenance mode. Take a look at the link:https://github.com/sebhoss/javapoet-type-guesser/issues[open tickets] for ways to help out.
